...
namespace USOS.Entities
{
    public class Student
    {
        ...
        [Required(ErrorMessage = "Index is required"), StringLength(6, ErrorMessage ="Index length must be exact 6 numbers"), DataType(DataType.Currency , ErrorMessage ="Example: 111234")]
